          ...
          <div className=" flex flex-col lg:flex-row gap-10 justify-between">
            ...
            <div className="flex-1  space-y-3 md:space-y-4 ">
              ...
              <p className="text-lg font-[archivo] text-[#4D5765]">
                Have a query or project in mind? Get in touch with us today. Our
              ...
              <div className="flex items-center gap-3 border-[1px] border-[#E4E4E4] p-4">
                ...
                <p className="text-lg font-[600] font-[archivo] text-[#0E121D] flex-1">
                  Plot #37, Room #B-248 (3rd Floor), Gulshan Shooping Center,
                  Gulsha-1,Dhaka-1212
                </p>
              </div>
            ...
            <div className="flex-1  space-y-3 md:space-y-4 ">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-5 items-center">
                <div className="w-full">
                  <p className="text-base font-[600] font-[archivo] text-[#0E121D]">
                    Full Name
                  </p>
                  <input
              ...
              {/* button  */}
              <div>
                <button className="bg-[#F68A0A] hover:bg-[#ee8404] transform transition-all duration-300 text-white text-sm font-[archivo] font-[500] px-7 py-4 flex items-center gap-1">
                  SEND A MESSAGE
                </button>
              </div>
            </div>
