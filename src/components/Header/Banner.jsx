    ...
    return(
        <Fragment>
            ...
            className=" w-full h-[800px] bg-no-repeat bg-cover relative">
             ...
             {/* text  */}
            <div
                className="space-y-3 md:space-y-4 top-2/4 absolute -translate-y-2/4 left-2/4 -translate-x-2/4 lg:-translate-x-0  lg:left-10 xl:left-20 2xl:left-28 ">

                <h2 className="text-[#F68A0A] font-[titillium] uppercase text-[18px] md:text-[20px] font-[600]">WELCOME TO
                    DREAMS CONSTRUCTION
                </h2>

                <h3
                    className="text-white font-[titillium] text-[24px] md:text-[38px] xl:text-[48px] 2xl:text-[74px] font-[700] uppercase ">
                    BUILD A BETTER
                    <br/>
                    TOMORROW.
                </h3>

                <p className="text-[#908C8D] text-sm md:text-base font-[archivo]">The Construction industry encompasses the
